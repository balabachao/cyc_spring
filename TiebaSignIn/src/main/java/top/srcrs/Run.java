...
public class Run
{
    ...
    public static void main( String[] args ){
        ...
        cookie.setBDUSS("4xLUNuVjhUWTNwcTJNOEFzTk0zVUJWfldPbW5mVktCODJqbnZZTTIxcEVIQzVnSVFBQUFBJCQAAAAAAAAAAAEAAACwTTsiv-Bf0NDJrgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAESPBmBEjwZgWX;");
        // 存入Cookie，以备使用
/*        if(args.length==0){
    ...
    public void send(String sckey){
        ...
        String body = text+desp;
        StringEntity entityBody = new StringEntity(body,"UTF-8");
        HttpClient client = HttpClients.createDefault();
        HttpPost httpPost = new HttpPost("https://api.day.app/"+sckey+"/");
        String url ="https://api.day.app/4ppVFBUZxhEnxPzumvtsdF/百度贴吧签到/"+body;

        UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(url);
        HttpGet httpGet =new HttpGet(builder.build().encode().toUri());
